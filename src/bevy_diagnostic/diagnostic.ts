...
export class Diagnostic {
	 ...
	 * @returns 诊断实例
	 */
	static create(path: DiagnosticPath): Diagnostic {
...
export function installDiagnosticSystem(app: import("../bevy_app/app").App): void {
	(
		app as unknown as {
			_registerDiagnosticImpl?: (app: import("../bevy_app/app").App, diagnostic: unknown) => void;
		}
	)._registerDiagnosticImpl = (appInstance, diagnostic) => {
		registerDiagnostic(appInstance, diagnostic as Diagnostic);
	};
}
